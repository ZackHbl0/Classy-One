...
<?php $component->withAttributes(['class' => 'fi-wi-stats-overview']); ?>
    ...
    <div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div class="flex items-center gap-3">
            <a href="<?php echo e(\App\Filament\Resources\StudentResource::getUrl('index')); ?>" 
...
<?php endif; ?>
            ...
            <a href="<?php echo e(\App\Filament\Resources\PaiementResource::getUrl('create')); ?>" 
...
<?php endif; ?>
            ...
            <div class="flex-1">
                ...
                <div class="flex items-baseline gap-2 mt-1">
                    <span class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($totalRevenue, 2)); ?></span>
