...
<?php $component->withAttributes([]); ?>
    ...
    <div style="background-color: white; border-radius: 1rem; border: 1px solid #f3f4f6; padding: 1.5rem; margin-bottom: 2rem; box-shadow: 0 1px 2px 0 rgba(0,0,0,0.05); width: 100%;">
        <label for="classe_id" style="display: block; font-size: 0.875rem; font-weight: 600; color: #374151; margin-bottom: 0.75rem; text-transform: uppercase; letter-spacing: 0.05em;">
            Sélectionner une classe
        </label>
        
        <div style="position: relative; display: flex; align-items: center;">
            <div style="position: absolute; left: 1rem; color: #6b7280; pointer-events: none; width: 1.25rem; height: 1.25rem;">
...
<?php endif; ?>
            ...
            <select wire:model.live="classe_id" id="classe_id"
                style="width: 100%; appearance: none; background-color: #f9fafb; border: 1px solid #e5e7eb; border-radius: 0.75rem; padding: 0.75rem 2.5rem 0.75rem 2.75rem; font-size: 0.95rem; font-weight: 500; color: #1f2937; outline: none; transition: border-color 0.2s, box-shadow 0.2s; cursor: pointer; box-shadow: inset 0 1px 2px rgba(0,0,0,0.02);">
            ...
            <div style="position: absolute; right: 1rem; color: #9ca3af; pointer-events: none; width: 1rem; height: 1rem;">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->plannings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day => $courses): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div x-show="activeTab === '<?php echo e($day); ?>'" x-cloak>
                        ...
                        <div style="margin-bottom: 1.5rem;">
                            <h2 style="font-size: 1.125rem; font-weight: 600; color: #374151; margin: 0;"><?php echo e($day); ?></h2>
                        </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\Classy-One\resources\views/filament/resources/planning-resource/pages/list-plannings.blade.php ENDPATH**/ ?>