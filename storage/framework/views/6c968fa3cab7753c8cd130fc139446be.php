...
<?php $component->withAttributes([]); ?>
    <div class="flex justify-between items-center mb-6">
        ...
        <div>
            <?php echo e($this->createGradeAction); ?>

        </div>
    </div>

    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->grades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div
                class="bg-white dark:bg-gray-800 border <?php echo e(match ($grade->color) {'success' => 'border-success-200','info' => 'border-info-200','primary' => 'border-primary-200','warning' => 'border-warning-200','danger' => 'border-danger-200',default => 'border-gray-200'}); ?> rounded-2xl shadow-sm p-6 relative overflow-hidden flex flex-col justify-between group transition hover:shadow-md">

                <!-- Top border indicator logic -->
                <div
                    class="absolute top-0 left-0 w-1.5 h-full <?php echo e(match ($grade->color) {'success' => 'bg-success-500','info' => 'bg-info-500','primary' => 'bg-primary-500','warning' => 'bg-warning-500','danger' => 'bg-danger-500',default => 'bg-gray-500'}); ?>">
                </div>
...
<?php $component->withName('heroicon-s-book-open'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
                            ...
                            <div class="flex flex-col pt-1">
                                <h3
                                    ...
                                    <?php echo e($grade->subject_name ?? 'N/A'); ?></h3>
                            </div>
                        </div>
                        <div class="text-right whitespace-nowrap pl-3">
                            <div
                                class="text-2xl font-black <?php echo e(match ($grade->color) {'success' => 'text-success-600','info' => 'text-info-600','primary' => 'text-primary-600','warning' => 'text-warning-600','danger' => 'text-danger-600',default => 'text-gray-900'}); ?>">
                                <?php echo e($grade->formatted_note); ?> <span class="text-base font-bold opacity-60">/ 20</span>
                            </div>
                            <div
                                class="text-xs font-bold inline-block mt-1 <?php echo e(match ($grade->color) {'success' => 'text-success-600','info' => 'text-info-600','primary' => 'text-primary-600','warning' => 'text-warning-600','danger' => 'text-danger-600',default => ''}); ?>">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($grade->note >= 10): ?>
                                    <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-3.5 h-3.5 inline-block -mt-0.5']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php $component = $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?> <?php echo e($grade->type); ?>

                        </span>
                        <span
                            class="px-3 py-1 rounded-lg text-xs font-bold border border-success-200 bg-success-50 text-success-700 shadow-sm">
                            <?php echo e($grade->classe?->nomClasse ?? ($this->record->registres->last()?->classe?->nomClasse ?? 'Classe')); ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($grade->coefficient && (float) $grade->coefficient > 0): ?>
                        <span
...
<?php $component = $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?> Coeff. <?php echo e(number_format((float)$grade->coefficient, 1)); ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                            <span><?php echo e($grade->exam_date?->format('d/m/Y')); ?></span>
                        </div>
                        <?php
                        ...
                        ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canManageThisGrade): ?>
                            <div class="flex items-center gap-3">
                                <button wire:click="mountAction('editGrade', { grade_id: <?php echo e($grade->id); ?> })"
...
<?php endif; ?>
                                ...
                                <button wire:click="mountAction('deleteGrade', { grade_id: <?php echo e($grade->id); ?> })"
...
<?php endif; ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->grades->isEmpty()): ?>
            <div
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\Classy-One\resources\views/filament/resources/grade-resource/pages/view-student-grades.blade.php ENDPATH**/ ?>