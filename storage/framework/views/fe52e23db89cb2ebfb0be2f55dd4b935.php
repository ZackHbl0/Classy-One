...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-6 h-6 text-indigo-600 dark:text-indigo-400']); ?>
...
<?php endif; ?>
            ...
            <div class="flex-1">
                ...
                <div class="flex items-baseline gap-2 mt-1">
                    <span
                        class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($totalStudents)); ?></span>
                    <span class="text-xs font-medium text-emerald-500"><?php echo e($studentsGrowth); ?></span>
                </div>
            </div>
        </div>
...
<?php endif; ?>
            ...
            <div class="flex-1">
                ...
                <div class="flex items-baseline gap-2 mt-1">
                    <span
                        class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($totalRevenue, 2)); ?></span>
                    <span class="text-xs font-medium text-gray-500">MAD</span>
                </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pendingPaymentsSum > 0): ?>
                    <div class="text-[10px] font-medium text-amber-500 mt-1">
                        <?php echo e(number_format($pendingPaymentsSum, 2)); ?> MAD pending
                    </div>
...
<?php endif; ?>
            ...
            <div class="flex-1">
                ...
                <div class="flex items-baseline gap-2 mt-1">
                    <span
                        class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($totalNotifications)); ?></span>
                    <span class="text-xs font-medium text-emerald-500"><?php echo e($notificationsGrowth); ?></span>
                </div>
            </div>
        </div>
...
<?php endif; ?>
            ...
            <div class="flex-1">
                ...
                <div class="flex items-baseline gap-2 mt-1">
                    <span
                        class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($upcomingEvents)); ?></span>
                    <span class="text-xs font-medium text-gray-500">Next: <?php echo e($nextEventDate); ?></span>
                </div>
            </div>
        </div>
...
<?php endif; ?>
            ...
            <div class="flex-1">
                ...
                <div class="flex items-baseline gap-2 mt-1">
                    <span
                        class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($overduePayments)); ?></span>
                    <span class="text-xs font-medium text-red-500"><?php echo e(number_format($overduePayments)); ?> overdue</span>
                </div>
            </div>
        </div>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\Classy-One\resources\views/filament/widgets/dashboard-stats.blade.php ENDPATH**/ ?>